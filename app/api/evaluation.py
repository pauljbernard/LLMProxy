...
from app.schemas.evaluation import EvaluationResult, EvaluationRunRequest, EvaluationRunView
...
async def list_evaluation_runs_endpoint(
    ...
    return [
        EvaluationRunView(
            ...
            promotion_status=str(run.result_json.get("promotion_status", "unknown")),
            package_manifest_path=str(run.result_json.get("package_manifest_path", "")),
        )
        for run in runs
    ]
